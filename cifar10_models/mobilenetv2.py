##########################################################
# CODE BORROWED FROM HUY PHAN's GITHUB REPOSITORY:
# https://github.com/huyvnphan/PyTorch_CIFAR10
# See this profile for downloaded the pre-trained models
# We used this code to run some experiments on 
# CIFAR-10 dataset for the AMLoE project
##########################################################
